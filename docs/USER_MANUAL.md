...
This manual describes version 0.13.8 of the X-Plane 737NG Maintenance Toolkit.
...
At startup, version 0.13.8 checks immutable `catalog-v*` releases in the Toolkit
