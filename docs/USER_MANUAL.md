...
This manual describes version 0.17.1 of the X-Plane 737NG Maintenance Toolkit.
...
At startup, version 0.17.1 checks immutable `catalog-v*` releases in the Toolkit
