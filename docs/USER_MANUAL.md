...
This manual describes version 0.13.12 of the X-Plane 737NG Maintenance Toolkit.
...
At startup, version 0.13.12 checks immutable `catalog-v*` releases in the Toolkit
