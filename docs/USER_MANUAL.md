...
This manual describes version 0.13.7 of the X-Plane 737NG Maintenance Toolkit.
...
At startup, version 0.13.7 checks immutable `catalog-v*` releases in the Toolkit
