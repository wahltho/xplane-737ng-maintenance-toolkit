...
This manual describes version 0.12.2 of the X-Plane 737NG Maintenance Toolkit.
...
explicit confirmation before writing files. Version 0.12.2 offers the LevelUp
...
At startup, version 0.12.2 checks immutable `catalog-v*` releases in the Toolkit
...
aircraft, VNAV and tool transactions. Version 0.12.2 offers the official
...
offered automatically after an aircraft update. The 0.12.2 catalog advertises
