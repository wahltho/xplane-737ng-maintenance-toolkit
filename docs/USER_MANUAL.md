...
This manual describes version 0.19.0 of the X-Plane 737NG Maintenance Toolkit.
...
At startup, version 0.19.0 checks immutable `catalog-v*` releases in the Toolkit
